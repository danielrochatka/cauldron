...
class AdminAIRun(models.Model):
    ...
    prompt_global_version = models.CharField(max_length=64, blank=True, default="")
    prompt_tool_versions = models.JSONField(default=dict, blank=True)
    prompt_included_tools = models.JSONField(default=list, blank=True)
